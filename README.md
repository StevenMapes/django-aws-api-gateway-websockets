[![CI Build Status](https://img.shields.io/github/actions/workflow/status//main.yml?branch=main)](https://github.com/StevenMapes/django-aws-api-gateway-websockets/actions)
